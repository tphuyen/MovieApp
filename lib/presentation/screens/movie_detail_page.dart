...
import 'package:movie_app/presentation/widgets/cast_card.dart';
...
class MovieDetailPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    movieBloc.add(FetchMovieDetails(movie.id));
        ...
        body: BlocBuilder<MovieBloc, MovieState>(
          builder: (context, state) {
            if (state.isLoading) {
              ...
              return const Center(
                child: Text("Try to connect internet again or this film is not Available"));
                              ...
                              children: [
                                ...
                                Expanded(
                                    ...
                                    child: Align(
                                      ...
                                      child: IconButton(
                                        icon: BlocBuilder<SavedMovieBloc, SavedMovieState>(
                                          builder: (context, state) {
                                            bool isSaved = false;
                                            if (state is SavedMovieLoaded) {
                                              isSaved = state.savedMovies.any((m) => m.id == movie.id);
                                            }
